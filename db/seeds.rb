...
Plant.create(name: 'Cactus', image_url: 'cactus.jpg')
Plant.create(name: 'Chamaedorea', image_url: 'medium-chamaedorea.jpg')
...
Plant.create(name: 'Dracaena Fragancia', image_url: 'dracaena-fragrans.jpg')
...
Plant.create(name: 'Zamioculcas', image_url: 'medium-zamioculcas.jpg')
